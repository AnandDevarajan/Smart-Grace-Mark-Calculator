...
//   const gracemarkEditHandler = (id) => {};
//   const gracemarkdeleteHandler=(id)=>{}
              ...
              <tr key={gracemark.GraceMarkID}>
                ...
                <td>
                  <EditIcon
                    className='icon'
                    style={{ color: 'black' }}
                    onClick={() => gracemarkEditHandler(gracemark.GraceMarkID)}
                  />
                </td>
                <td>
                  <DeleteIcon
                    ...
                    style={{ color: '#f05454' }}
                    onClick={() =>
                      gracemarkdeleteHandler(gracemark.GraceMarkID)
                    }
                  />
                </td>
              </tr>
