...
describe("Admin", () => {
  ...
  describe("GET /admin/student/request/accept/:id", () => {
    it("Accept gracemark request", (done) => {
      chai
        .request("http://127.0.0.1:5000")
        .get("/admin/student/request/accept/test2")
        .set(
          "Authorization",
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6InRlc3QxIiwiaWF0IjoxNjIwODUwNTA3LCJleHAiOjE2MjM0NDI1MDd9.FkhNjlwgDlQ1rhSTLTa5oBEd0M5FRpYdjqFx3SRT054"
        )
        .end((err, res) => {
          if (err) done(err);
          console.log(res);
